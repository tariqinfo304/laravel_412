...
<body>
    ...
    <main>
        <form id="login_form" class="form_class" action="{{ URL('store/user/login') }}" method="post">
            ...
            <div class="form_div">
                @csrf()
                <label>Login:</label>
                <input class="field_class" name="username" type="text" placeholder="Enter Username" autofocus>
                @error("username")
            ...
            <div class="info_div">
                <p>Register yourself if you have not already account? 
                    <a href="{{ URL('store/user/register') }}">Register</a></p>
            </div>
        </form>
    </main>
</body>